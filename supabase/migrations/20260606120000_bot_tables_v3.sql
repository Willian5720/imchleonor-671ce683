...
DROP POLICY IF EXISTS "bot_settings_own_select" ON public.bot_settings;
CREATE POLICY "bot_settings_own_select" ON public.bot_settings FOR SELECT TO authenticated USING (auth.uid() = user_id);
DROP POLICY IF EXISTS "bot_settings_own_insert" ON public.bot_settings;
CREATE POLICY "bot_settings_own_insert" ON public.bot_settings FOR INSERT TO authenticated WITH CHECK (auth.uid() = user_id);
DROP POLICY IF EXISTS "bot_settings_own_update" ON public.bot_settings;
CREATE POLICY "bot_settings_own_update" ON public.bot_settings FOR UPDATE TO authenticated USING (auth.uid() = user_id);
...
DROP POLICY IF EXISTS "bot_logs_own_select" ON public.bot_logs;
CREATE POLICY "bot_logs_own_select" ON public.bot_logs FOR SELECT TO authenticated USING (auth.uid() = user_id OR user_id IS NULL);
...
DROP POLICY IF EXISTS "bot_notif_own_select" ON public.bot_notifications;
CREATE POLICY "bot_notif_own_select" ON public.bot_notifications FOR SELECT TO authenticated USING (auth.uid() = user_id);
DROP POLICY IF EXISTS "bot_notif_own_update" ON public.bot_notifications;
CREATE POLICY "bot_notif_own_update" ON public.bot_notifications FOR UPDATE TO authenticated USING (auth.uid() = user_id);
